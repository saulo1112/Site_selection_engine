...
- **NDCG@200**: 0.8495 (calidad del orden en el top-K; 1.0 = perfecto).
- **Precision@200**: 0.8200 (164 de las 200 celdas mejor rankeadas ya tienen D1).
- **top-200 hitting** (recall de positivos en el top-K): 0.1866 (techo = 0.2275, porque hay 879 positivos > K=200: ni un ranking perfecto puede capturarlos todos en solo K celdas).
- **top-200 loss** (positivos fuera del top-K): 0.8134
- Positivos en el top-200: **164** de 879 positivos totales (3589 hexagonos).

> **Lectura honesta:** el `hitting` parece bajo solo porque hay muchos mas positivos (879) que celdas seleccionadas (K=200). La metrica mas informativa aqui es **Precision@200 = 0.820** y el **NDCG@200 = 0.849**: un baseline sin ML que ordena bien las celdas mas parecidas a las de D1. v2/v3 deberan superarlo (o, en v3, revelar cuanto de esto era leakage espacial).
